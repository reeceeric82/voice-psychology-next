...
const DatenschutzPage = () => {
    ...
    return (
        <>
            {isMobile ? <MobileDatenschutz /> : <DesktopDatenschutz />}
        </>
  );
};

const DesktopDatenschutz = () => {
    return (
        <Stack
      as={Box}
      textAlign={"center"}
      ...
      <Stack textAlign={"left"}>
        ...
        <Stack spacing={6}>
          <Stack
            ...
            id="allgemeine-hinweise-und-pflichtinformation"
          >
            <Text as={"b"} fontSize={"3xl"}>
          ...
          <Text as={"b"} fontSize={"2xl"}>
            2.2 Hinweise zur veranrwortlichen Stelle
          </Text>
          <Text as={"b"} fontSize={"xl"}>
            Die veranrwortliche Stelle f&#252;r die Datenverarbeitung auf dieser
            Website ist:
          </Text>
          ...
          <Text as={"b"} fontSize={"2xl"}>
            2.3 Wilderruf Iher Einwilligung zur Datenverarbeitung
          </Text>
          <Text fontSize={"xl"}>
          ...
          <Text fontSize={"xl"}>
            ...
            Liste der Datenschutzbeauftragten sowie deren Kontaktdaten finden
            Sie
            <Link
              color="orange.200"
        ...
        <Stack spacing={6}>
          <Stack
            divider={<StackDivider />}
            id="datenerfassung-auf-unserer-website"
          >
            <Text as={"b"} fontSize={"3xl"}>
          ...
          <Text fontSize={"xl"}>
            ...
            erlauben, die Annahme von Cookies f&#252;r bestimmte F&#338;lle oder
          ...
          <Text fontSize={"xl"}>
            ...
            erw&#252;nschter Funktionen (z.B. Warenkorbfunktion) erforderlich
            ...
            werden diese in dieser Datenschutzerkl&@228;rung gesondert
            behandelt.
          </Text>
          ...
          <Text as={"b"} fontSize={"2xl"}>
            3.4 Registrierung auf dieser Website (G&#228;stebuch)
          </Text>
          <Text fontSize={"xl"}>
            ...
            jeweiligen Angebotes oder Dienstes, f&#252;r den Sie sich
            registriert haben. Die bei der Registrierung abgefragten
            Pflichtangaben m&#252;ssen vollst&#228;ndig angegeben werden.
            Anderenfalls werden wir die Registrierung ablehnen. F&#252;r
          ...
          <Text fontSize={"xl"}>
            ...
            Registrierung erfassten Daten werden von uns gespeichert, solange
            Sie auf unserer Website registriert sind und werden
            anschlie&#223;end gel&#246;scht. Gesetzliche Aufbewahrungsfristen
            bleiben unber&#252;hrt.
          </Text>

          <Text as={"b"} fontSize={"2xl"}>
            3.5 Kommentarfunktion auf dieser Website (G&#228;stebuch)
          </Text>
          <Text fontSize={"xl"}>
          ...
          <Text fontSize={"xl"}>
            ...
            der Freischaltung pr&#252;fen, ben&#246;tigen wir diese Daten, um im
            Falle von Rechtsverletzungen wie Beleidigungen oder Propaganda gegen
            den Verfasser vorgehen zu k&#246;nnen.
          </Text>
          <Text as={"b"} fontSize={"xl"}>
          ...
          <Text fontSize={"xl"}>
            ...
            Kommentare aus rechtlichen Gr&#252;nden gel&#246;scht werden
          ...
          <Text fontSize={"xl"}>
            ...
            formlose Mitteilung per E-Mail an uns. Die Rechtm&#228;&#223;igkeit
            der bereits erfolgten Datenverarbeitungsvorg&@228;nge bleibt vom
            Widerruf unber&#252;hrt.
          </Text>

          <Text as={"b"} fontSize={"2xl"}>
            3.6 Verarbeiten von Daten (Kunden- und Vertragsdaten)
          </Text>
          <Text fontSize={"xl"}>
          ...
          <Text as={"b"} fontSize={"2xl"}>
            3.7 Datenübermittlung bei Vertragsschluss f&#252;r Online-Shops,
            H&#228;ndler und Warenversand
          </Text>
          <Text fontSize={"xl"}>
            Wir &#252;bermitteln personenbezogene Daten an Dritte nur dann, wenn
            dies im Rahmen der Vertragsabwicklung notwendig ist, etwa an die mit
            der Lieferung der Ware betrauten Unternehmen oder das mit der
            Zahlungsabwicklung beauftragte Kreditinstitut. Eine weitergehende
            &#220;bermittlung der Daten erfolgt nicht bzw. nur dann, wenn Sie
            der &#220;bermittlung ausdr&#252;cklich zugestimmt haben. Eine
          ...
          <Text as={"b"} fontSize={"2xl"}>
            3.8 Daten&#252;bermittlung bei Vertragsschluss f&#252;r
            Dienstleistungen und digitale Inhalte
          </Text>
          <Text fontSize={"xl"}>
            Wir &#252;bermitteln personenbezogene Daten an Dritte nur dann, wenn
            dies im Rahmen der Vertragsabwicklung notwendig ist, etwa an das mit
            der Zahlungsabwicklung beauftragte Kreditinstitut. Eine
            weitergehende &#220;bermittlung der Daten erfolgt nicht bzw. nur
            dann, wenn Sie der &#220;bermittlung ausdr&#252;cklich zugestimmt
            haben. Eine Weitergabe Ihrer Daten an Dritte ohne ausdr&#252;ckliche
            Einwilligung, etwa zu Zwecken der Werbung, erfolgt nicht. Grundlage
            f&#252;r die Datenverarbeitung ist Art. 6 Abs. 1 lit. b DSGVO, der
